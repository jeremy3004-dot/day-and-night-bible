...
Day and Night Bible is a mobile Bible meditation and prayer app built with Expo/React Native. It provides offline Bible reading, audio playback, guided prayer studies, discipleship courses (Four Fields), group study features, and multi-language support (EN, ES, NE, HI). The app uses Supabase for backend services and supports Apple/Google OAuth authentication.
...
- **CocoaPods:** May need manual installation (see global AGENTS.md for fix)
...
- 2026-01-29: Initial AGENTS.md created based on codebase analysis
- Future: Use # key to add instructions when Codex needs correction
