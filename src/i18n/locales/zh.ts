export const zh = {
  ...
  home: {
    ...
    goodAfternoon: '下午好',
    goodEvening: '晚上好',
    welcome: '欢迎来到Day and Night Bible',
    verseOfTheDay: '每日诗句',
  ...
  onboarding: {
    ...
    standardIconBody: '使用普通的Day and Night Bible图标并直接打开应用程序。',
  ...
  bible: {
    ...
    fullBibleComingSoon: '本章目前没有文本版本。如果音频可用，Day and Night Bible 将打开聆听体验。',
  ...
  privacy: {
    lockTitle: '输入您的安全代码',
    lockBody: '该设备处于谨慎模式。解锁 Day and Night Bible 以继续。',
  ...
  about: {
    title: '关于',
    version: '版本{{version}}',
    description: 'Day and Night Bible 是一种简单、美丽的阅读和学习神的话语的方式。',
